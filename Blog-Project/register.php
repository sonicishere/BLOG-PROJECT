...
if (!empty($_GET["msg"]) && $_GET["msg"] == 'ar') {
    ...
    <div
        ...
        role="alert"
    >
        <strong>Alert</strong> You Are Already Registerd, Please <a href="index.php" style="text-decoration: none; color:white;">Login!</a>
    </div>
...
?>
    <div class="form-floating">
        <input type="text" name="name" class="form-control" id="floatingInput" placeholder="YosefElsersy" autocomplete="off">
